...
'''
This is so much horseshit, for fucks sake.
This shit is not debuggable and doesnt show up in references 
AND hides used classes from code search
'''
...
class SST2Dataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        d = load_dataset('Nyu-mll/glue', 'sst2')
        train_d = d["train"]
