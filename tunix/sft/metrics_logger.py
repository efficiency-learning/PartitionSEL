...
class MetricsLogger:
  ...
  def __init__(
    ...
    self._metrics = collections.defaultdict(lambda: collections.defaultdict(list))
    self._metrics[Mode.TRAIN] = collections.defaultdict(list)
    self._metrics[Mode.EVAL] = collections.defaultdict(list)
